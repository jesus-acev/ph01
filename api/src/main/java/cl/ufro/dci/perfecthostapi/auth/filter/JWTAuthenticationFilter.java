...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
     ...
     * @param response Response, it needed in layering authentication cases. Respuesta, necesaria en casos de autentificación por capas.
     ...
     *              Usuario actual.
     * @return Map that represents the body of successfulAuthentification. Map que representa el body de successfulAuthentification.
     */
     ...
     * @return Map that represents the body of unsuccessfulAuthentification. Map que representa el body de unsuccessfulAuthentification.
     */
